...
import MobileSwipeCard from '../components/mobile/MobileSwipeCard';
import MobileHeader from '../components/mobile/MobileHeader';
import { useMobileFeatures } from '../hooks/useMobileFeatures';
import { Star, RefreshCw } from 'lucide-react';

const MobileSwipePage: React.FC = () => {
  const { user } = useAuth();
  const navigate = useNavigate();
  const { hapticFeedback, isNative, showLocalNotification } = useMobileFeatures();
...
export default MobileSwipePage;